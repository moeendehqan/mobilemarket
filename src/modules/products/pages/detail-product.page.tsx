    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                {/* Header Section */}
                <div className="bg-white rounded-2xl shadow-xl p-6 mb-8 backdrop-blur-sm">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">{product.model_mobile?.model_name}</h1>
                            ...
                            {product.status_product && (
                                <span
                                    className={`px-4 py-2 rounded-full text-sm font-medium shadow-sm ${
                                        statusMap[product.status_product]?.class
                                    }`}>
                                        ...
                                        {product.battry_health && (
                                            <div className="w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
                                                <div
                                                    ...
                                                    style={{ width: `${product.battry_health}%` }}></div>
                                            </div>
                                        )}
                                        <span className="font-semibold text-gray-800">
                                            {product.battry_health ? `${product.battry_health}%` : "-"}
                                        </span>
                                    </div>
                                </div>
                                <div className="flex justify-between items-center py-3 border-b border-gray-100 last:border-b-0">
                                    ...
                                    <div className="flex justify-between items-center py-3 border-b border-gray-100 last:border-b-0">
                                        ...
                                        <span
                                            className={`px-3 py-1 rounded-full text-sm font-semibold ${
                                                guarantorMap[product.guarantor]?.class
                                            }`}>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {pictureData.map((picture, index) => (
                                        <div
                                            key={picture.id}
                                            className="bg-gradient-to-br from-gray-50 to-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center py-3 border-b border-gray-100 last:border-b-0">
                                    ...
                                    <span
                                        className={`px-3 py-1 rounded-full text-sm font-semibold ${
                                            statusMap[product.status_product || ""]?.class || "bg-gray-100 text-gray-800"
                                        }`}>
                                        {statusMap[product.status_product || ""]?.text || "-"}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center py-3 border-b border-gray-100 last:border-b-0">
                                    ...
                                    <span
                                        className={`px-3 py-1 rounded-full text-sm font-semibold ${
                                            typeMap[product.type_product || ""]?.class || "bg-gray-100 text-gray-800"
                                        }`}>
                                        {typeMap[product.type_product || ""]?.text || "-"}
                                    </span>
                                </div>
